...
function getCookie(name) {
    ...
    if (document.cookie && document.cookie !== '') {
        ...
        for (let i = 0; i < cookies.length; i++) {
            ...
            // Sprawdź, czy cookie zaczyna się od poszukiwanej nazwy
...
function App() {
    ...
    const handleSaveChanges = (updatedSite) => {
        ...
        fetch(`/api/monitored-sites/${siteId}/`, {
            ...
            headers: {
                ...
                'X-CSRFToken': getCookie('csrftoken'),  // Dodanie tokenu CSRF
            },
    ...
    const handleDeleteSite = () => {
        const siteId = selectedSite.id;
        fetch(`/api/monitored-sites/${siteId}/delete/`, {  // Poprawiona ścieżka do usuwania
            method: 'DELETE',
            headers: {
                'X-CSRFToken': getCookie('csrftoken'),  // Dodanie tokenu CSRF
            },
